...
public class SommerFlaxWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SommerFlaxWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SommerFlaxWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SommerFlaxWLAIW/InitOutcome.xml").getDocumentElement();
